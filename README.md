...
[![CI](https://github.com/720zjj/Xf-RAG/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/720zjj/Xf-RAG/actions/workflows/ci.yml)
...
项目使用 Node.js 22 与 MySQL 8。完成环境变量配置和数据库迁移后，可通过以下命令复现自动化验证与前端生产构建：
...
快速体验时，建议依次完成“管理员上传并审核资料 → 选择产品型号提问 → 查看答案引用来源”的流程，以验证资料隔离、混合检索和来源追溯。
...
- **多工具 Agent**：可按问题选择知识库检索、摘要、翻译、文档管理、SOP 查询和视频检索等工具。
